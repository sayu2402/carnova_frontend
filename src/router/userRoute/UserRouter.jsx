...
import IDCardUploadPage from "../../pages/userPages/IDCardUploadPage";
...
function UserRouter() {
  return (
    <Routes>
      ...
      <Route path="/dashboard/:username/id-card-upload" element={<UserPrivate><IDCardUploadPage/></UserPrivate> } />
    </Routes>
  );
}
