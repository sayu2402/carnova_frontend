  ...
  return (
    <div className="bg-slate-200 py-12">
      ...
      <h4 className="text-lg font-semibold text-center text-gray-800 mb-8">
        To ensure the safety and compliance of our rent-a-car service, we kindly
        request you to upload a picture of your valid driver's license. Rest
        assured, we prioritize the confidentiality of your personal information
        and do not share your profile details.
      </h4>
